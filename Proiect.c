...
void template_matching(char *cale_imagine, char *cale_sablon, double ps, unsigned *nv, struct detectii **v, struct pixel C)
{   ///transformam imaginea si sablonul in tonuri de gri
...
void pattern_recognition(char *sursa, unsigned int *n, struct detectii **v)
{
    ...
    fscanf(in,"%s",sablon);
    C.b=255; C.g=255; C.r=0;
    template_matching(sursa, sablon,ps, n, v,C);
    fscanf(in,"%s",sablon);
    C.b=0; C.g=255; C.r=0;
    template_matching(sursa, sablon,ps, n, v,C);
    fscanf(in,"%s",sablon);
    C.b=0; C.g=255; C.r=255;
    template_matching(sursa, sablon,ps, n, v,C);
    fscanf(in,"%s",sablon);
    C.b=255; C.g=0; C.r=255;
    template_matching(sursa, sablon,ps, n, v,C);
    fscanf(in,"%s",sablon);
    C.b=0; C.g=0; C.r=255;
    template_matching(sursa, sablon,ps, n, v,C);
    fscanf(in,"%s",sablon);
    C.b=192; C.g=192; C.r=192;
    template_matching(sursa, sablon,ps, n, v,C);
    fscanf(in,"%s",sablon);
    C.b=255; C.g=140; C.r=0;
    template_matching(sursa, sablon,ps, n, v,C);
    fscanf(in,"%s",sablon);
    C.b=128; C.g=0; C.r=128;
    template_matching(sursa, sablon,ps, n, v,C);
    fscanf(in,"%s",sablon);
    C.b=128; C.g=0; C.r=0;
    template_matching(sursa, sablon,ps, n, v,C);
